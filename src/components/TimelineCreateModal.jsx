...
export const TimelineCreateModal = ({ onClose, onCreate }) => {
    ...
    const handleSubmit = (e) => {
        ...
        onCreate(formData.name, formData.description, formData.coverImage, formData.themeId);
    };
        ...
        <div style={{
            ...
            >
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
                    <h2 style={{ fontSize: '1.5rem', fontWeight: '700' }}>Nueva Línea de Tiempo</h2>
